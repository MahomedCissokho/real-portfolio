...
const Skills = () => {
  ...
  return(
      <div className=' max-w-6xl mx-auto px-3 flex flex-col justify-center'>
          <div className='flex flex-col'>
              <span className="w-0.5 rotate-90 h-10 left-6 relative bg-gray-700"></span>
              <h2 className='text-neutral-800 text-3xl font-extrabold dark:text-white pb-5'>Skills</h2>
              <div className='flex flex-row gap-10 px-10 tracking-wide leading-relaxed items-center'>
                  <cite className='w-7/12 text-gray-800 text-xl dark:text-gray-500'> {" Easy is not a option..  No days off..  Never Quit.. Be Fearless.. Talent you have Naturally.. Skill is only developed by hours and hours of Work . "}</cite>
                  <span className='font-bold text-xl dark:text-white'>- Usain BOLT</span>
              </div>
          </div>
          <div className='flex flex-row justify-center -mt-56 items-center gap-10 px-3'>
              <div className='w-3/6'>
              ...
              <div className='h-[53rem] w-3/6 mt-[25rem]'>
                  <span className="w-0.5 rotate-90 h-20 -mb-8 bg-gray-700"></span>
